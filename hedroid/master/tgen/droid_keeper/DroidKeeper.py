...
class Client(Iface):
  ...
  def send_release_endpoint_for_user(self, user):
    self._oprot.writeMessageBegin('release_endpoint_for_user', TMessageType.CALL, self._seqid)
...
class Processor(Iface, TProcessor):
  ...
  def process_get_endpoint_for_user(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.ae = ae
    oprot.writeMessageBegin("get_endpoint_for_user", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_interact_with_endpoint(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.ae = ae
    oprot.writeMessageBegin("interact_with_endpoint", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
